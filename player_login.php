<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
    ...
    $pass=$_POST["password"];
      ...
      $sql="SELECT * FROM `players` WHERE `Ref.No`='$ref' AND `Password`='$pass';";
