<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
    ...
    $pass=$_POST["pwd"];
      ...
      $sql="SELECT * FROM `coaches` WHERE `Email`='$email' AND `Password`='$pass';";
                            ...
                            <div class="card-body mt-2 mb-2 p-5">
                                ...
                                <form action="coach_login.php" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmlogin" name="frmlogin" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    ...
                                    <!-- <form name="frmlogin" id="frmlogin" action="" method="post"
                                        ...
                                        <h1 class="text-center mb-2">Coach Sign In</h1> <br>
